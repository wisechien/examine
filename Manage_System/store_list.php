...
function up(id,index){
	...
	document.form1.action="<?php echo $web_url?>?id=" + id + "&indexNo=" + index;
  ...
  <!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"> 教 材 商 品</h1>
                    </div>
		...
		$des = delHtml($des);
	 	$short_des = cutStr($des,80); 
			...
			// Process END
			?>
          <td><a href="page_news.php?id=<?php echo $id;?>" class="navigation"><img src="images/editor.gif" alt="" width="22" height="22"></a></td>
          <td>&nbsp;<?php  echo $udate;?></td>
          <td><?php echo $be_top_str;?><?php  echo $title;?> <?php  echo $be_top;?></td>
         ...
         <TD height="22" align=center bgColor="<?php  echo $bg_Color;?>" style="padding-left:2px"><table border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td>
						    <?php if($indexNo > 1){?>
								<a href='javascript:up(<?php echo $line["id"]?>,<?php echo $indexNo?>);'><img src="images/admin/order_asc.gif" width="13" height="13" border="0" class="delete"></a>
							<?php }else{?>
								&nbsp;
							<?php }?>						 </td>
						<td>
							<?php if($indexNo < $rows ){?>
							<a href='javascript:down(<?php echo $line["id"]?>,<?php echo $indexNo?>);'><img src="images/admin/order_desc.gif" width="13" height="13" border="0" class="delete"></a>
							<?php }else{?>
							&nbsp;
							<?php }?>					    </td>
					  </tr>
				  </table></TD>
         <td><A href="javascript:del('<?php  echo $web_url;?>?u=del&page=<?php  echo $int_page;?>&id=<?php echo $line['id'];?>');"><img src="images/delete.png" width="16" height="16"></A></TD>
        </tr>
