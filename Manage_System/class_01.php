             ...
             <form role="form" name="form1" enctype="multipart/form-data" action="" method="post">
              ...
              <INPUT type="hidden" name="ext_0" value="">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr> 
                                           <th colspan="2"><h4><i class="fa fa-plus-square "> 點讀筆介紹 </i></h4> </th>
                                         </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="Title" class="form-control" placeholder="點讀筆介紹" readonly></td>
                                         </tr>
