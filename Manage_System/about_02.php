  ...
  <!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"> 關於 SuperABC</h1>
                    </div>
             ...
             <form role="form" name="form1" enctype="multipart/form-data" action="" method="post">
              ...
              <INPUT type="hidden" name="ext_0" value="">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr> 
                                           <th colspan="2"><h4><i class="fa fa-plus-square "> 品牌精神 </i></h4> </th>
                                         </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="Title" class="form-control" placeholder="品牌精神" readonly></td>
                                         </tr>
