             ...
             <form role="form" name="form1" enctype="multipart/form-data" action="" method="post">
              ...
              <INPUT type="hidden" name="ext_0" value="">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr> 
                                           <th colspan="2"><h4><i class="fa fa-plus-square"> 訊息公告新增  </i></h4> </th>
                                         </tr>
                                    </thead>
                                    <tbody>
                                       <tr>
                                            <td><label>訊 息 分 類</label></td>
                                            <td><select name="Class_Type" class="form-control">
                                                <option>活 動</option>
                                                <option>產 品</option>
                                                <option>考 試 資 訊</option>
                                                <option>視 頻</option> 
                                            </select></td>
                                         </tr>
                                        <tr>
                                         ...
                                         <tr> 
                                            <td> <label> 圖 片 上 傳 </label></td>
                                             <td><input name="FileUpload" type="file">  <label>(最佳尺寸：160px X 120px)</label> </td>
                                         </tr>
                                         <tr> 
                              ...
                              <textarea class="form-control" rows="3" name="des"><?php  echo $des;?></textarea>
                                         ...
                                         <tr> 
                                            <td> </td>
                                            <td><button type="button" class="btn btn-primary"onClick="sbForm();">Submit</button>
                                             
                                            <button type="button" class="btn btn-danger"> Reset </button></td>
                                          </tr>
                                    </tbody>
                                </table>
                                </form>
