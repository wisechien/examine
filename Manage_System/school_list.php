...
function up(id,index){
	...
	document.form1.action="<?echo $web_url?>?id=" + id + "&indexNo=" + index;
  ...
  <!-- /.navbar-static-side -->
		...
		$des = delHtml($des);
	 	$short_des = cutStr($des,80); 
			...
			// Process END
			?>
          <td><a href="page_news.php?id=<?echo $id;?>" class="navigation"><img src="images/editor.gif" alt="" width="22" height="22"></a></td>
          <td>&nbsp;<? echo $udate;?></td>
          <td><?echo $be_top_str;?><? echo $title;?> <? echo $be_top;?></td>
          <td><?echo $short_des;?></td>
         ...
         <td><A href="javascript:del('<? echo $web_url;?>?u=del&page=<? echo $int_page;?>&id=<?echo $line['id'];?>');"><img src="images/delete.png" width="16" height="16"></A></TD>
        </tr>
			...
			?>
                                ...
                                </form> <? require('../include/chgPage.php');?>
